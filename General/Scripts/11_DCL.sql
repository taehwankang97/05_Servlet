...
/* TEST_USER 계정에는 
*	 베이터베이스 접속 권한인 CREATE SESSION만 부여됨
*
...
/*TEST_USER 계정 접속*/
-- SELECT 권한을 부여 받은 KH계정의 EMPLOYEE 테이블조회 

SELECT * FROM KH_KTH.EMPLOYEE;
